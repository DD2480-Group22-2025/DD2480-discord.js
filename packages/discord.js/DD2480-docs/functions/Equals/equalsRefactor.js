...
class ApplicationCommand extends Base {
  ...
  equals(command, enforceOptionOrder = false) {
    // If we could assume that snake and camel case aren't both used in the same code base
    let defaultMemberPermissions = null;

    if ('defaultMemberPermissions' in command && command.defaultMemberPermissions !== null) {
      defaultMemberPermissions = PermissionsBitField(command.defaultMemberPermissions).bitfield
    }
