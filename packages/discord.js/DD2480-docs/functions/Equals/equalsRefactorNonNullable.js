...
class ApplicationCommand extends Base {
  ...
  equals(command, enforceOptionOrder = false) {
    // If we could assume that all fields exist as long as a command exists
    return (command.id !== this.id) 
        ...
        || (command.nsfw !== this.nsfw) 
        || (command.defaultMemberPermissions.bitfield !== this.defaultMemberPermissions.bitfield) 
        ...
        || !isEqual(command.integrationTypes, this.integrationTypes) 
        || !isEqual(command.contexts, this.contexts) 
        || !this.constructor.optionsEqual(this.options, command.options, enforceOptionOrder)
  }
